...
-- commenting tables
SELECT * FROM hydroa.riversegments
COMMENT ON TABLE hydroa.riversegments IS 'Table of river network data for Southern Mediterranean';
COMMENT ON COLUMN hydroa.riversegments."HYRIV_ID" IS 'Identifier of the segment';
COMMENT ON COLUMN hydroa.riversegments."NEXT_DOWN" IS 'Identifier of the next downstream river segment';
COMMENT ON COLUMN hydroa.riversegments."MAIN_RIV" IS 'Identifier of the most downstream river segment of the river basin';
COMMENT ON COLUMN hydroa.riversegments."LENGTH_KM" IS 'Length of the river segment';
COMMENT ON COLUMN hydroa.riversegments."DIST_DN_KM" IS 'Distance from the most downstream part of the segment to the most downstream part of the river network';
COMMENT ON COLUMN hydroa.riversegments."DIST_UP_KM" IS 'Distance from the most downstream part of the segment to the most upstream part of the river network';
-- TODO
--COMMENT ON COLUMN hydroa.riversegments."CATCH_SKM" IS '';
--COMMENT ON COLUMN hydroa.riversegments."UPLAND_SKM" IS '';
COMMENT ON COLUMN hydroa.riversegments."ENDORHEIC" IS 'Indicator for presence (1) or abscence (0) of a endorheic basin downstream of the segment';
COMMENT ON COLUMN hydroa.riversegments."DIS_AV_CMS" IS 'Average long-term discharge estimate for river reach, in m3 s-1';
COMMENT ON COLUMN hydroa.riversegments."ORD_STRA" IS 'Strahler rank';
COMMENT ON COLUMN hydroa.riversegments."ORD_CLAS" IS 'Classic stream rank';
COMMENT ON COLUMN hydroa.riversegments."ORD_FLOW" IS 'River order using average river discharge';
COMMENT ON COLUMN hydroa.riversegments."HYBAS_L12" IS 'Identifier of the HydroBASINS river basin level 12';
COMMENT ON COLUMN hydroa.riversegments.dis_m3_pyr IS 'Annual average of the natural discharge in m3';
COMMENT ON COLUMN hydroa.riversegments.dis_m3_pmn IS 'Annual minimum of the natural discharge in m3';
COMMENT ON COLUMN hydroa.riversegments.dis_m3_pmx IS 'Annual maximum of the natural discharge in m3';
COMMENT ON COLUMN hydroa.riversegments.run_mm_cyr IS 'Annual average land surface runoff in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.inu_pc_cmn IS 'Annual minimum Inundation Extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.inu_pc_umn IS 'Annual minimum Inundation Extent in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.inu_pc_cmx IS 'Annual maximum Inundation Extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.inu_pc_umx IS 'Annual maximum Inundation Extent in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.inu_pc_clt IS 'Long-term maximum Inundation Extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.inu_pc_ult IS 'Long-term maximum Inundation Extent in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.lka_pc_cse IS 'Limnicity (Percent Lake Area) spatial extent (%) in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.lka_pc_use IS 'Limnicity (Percent Lake Area) spatial extent (%) in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.lkv_mc_usu IS 'Sum of lake volume in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.rev_mc_usu IS 'Sum of reservoir volume in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.dor_pc_pva IS 'Degree of regulation at pour point of river reach';
COMMENT ON COLUMN hydroa.riversegments.ria_ha_csu IS 'Sum of river area in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.ria_ha_usu IS 'Sum of river area in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.riv_tc_csu IS 'Sum of river volume in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.riv_tc_usu IS 'Sum of river volume in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.gwt_cm_cav IS 'Average Groundwater Table Depth in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.ele_mt_cav IS 'Average elevation in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.ele_mt_uav IS 'Average elevation in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.ele_mt_cmn IS 'Minimum elevation in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.ele_mt_cmx IS 'Maximum elevation in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.slp_dg_cav IS 'Terrain slope in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.slp_dg_uav IS 'Terrain slope in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.sgr_dk_rav IS 'Average stream gradient along reach segment';
COMMENT ON COLUMN hydroa.riversegments.clz_cl_cmj IS 'Spatial majority of climate zone in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cls_cl_cmj IS 'Spatial majority of climate strata in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_cyr IS 'Annual average of air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_uyr IS 'Annual average of air temperature in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_cmn IS 'Annual minimum of air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_cmx IS 'Annual maximum of air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c01 IS 'Average January air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c02 IS 'Average February air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c03 IS 'Average March air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c04 IS 'Average April air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c05 IS 'Average May air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c06 IS 'Average June air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c07 IS 'Average July air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c08 IS 'Average August air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c09 IS 'Average September air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c10 IS 'Average October air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c11 IS 'Average November air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tmp_dc_c12 IS 'Average December air temperature in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_cyr IS 'Annual average of precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_uyr IS 'Annual average of precipitation in total watershed upstream in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c01 IS 'Average January precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c02 IS 'Average February precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c03 IS 'Average March precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c04 IS 'Average April precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c05 IS 'Average May precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c06 IS 'Average June precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c07 IS 'Average July precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c08 IS 'Average August precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c09 IS 'Average September precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c10 IS 'Average October precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c11 IS 'Average November precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pre_mm_c12 IS 'Average December precipitation in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_cyr IS 'Annual average of potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_uyr IS 'Annual average of potential evapotranspiration in total watershed upstream in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c01 IS 'January potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c02 IS 'February potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c03 IS 'March potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c04 IS 'April potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c05 IS 'May potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c06 IS 'June potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c07 IS 'July potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c08 IS 'August potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c09 IS 'September potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c10 IS 'October potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c11 IS 'November potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.pet_mm_c12 IS 'December potential evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_cyr IS 'Annual average of actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_uyr IS 'Annual average of actual evapotranspiration in total watershed upstream in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c01 IS 'January actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c02 IS 'February actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c03 IS 'March actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c04 IS 'April actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c05 IS 'May actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c06 IS 'June actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c07 IS 'July actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c08 IS 'August actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c09 IS 'September actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c10 IS 'October actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c11 IS 'November actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.aet_mm_c12 IS 'December actual evapotranspiration in reach catchment in mm';
COMMENT ON COLUMN hydroa.riversegments.ari_ix_cav IS 'Average global aridity index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.ari_ix_uav IS 'Average global aridity index in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_cyr IS 'Annual average climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_uyr IS 'Annual average climate moisture index in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c01 IS 'January climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c02 IS 'February climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c03 IS 'March climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c04 IS 'April climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c05 IS 'May climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c06 IS 'June climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c07 IS 'July climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c08 IS 'August climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c09 IS 'September climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c10 IS 'October climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c11 IS 'November climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cmi_ix_c12 IS 'December climate moisture index in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_cyr IS 'Annual average snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_uyr IS 'Annual average snow cover extent in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_cmx IS 'Annual maximum snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c01 IS 'January snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c02 IS 'Fevruary snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c03 IS 'March snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c04 IS 'April snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c05 IS 'May snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c06 IS 'June snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c07 IS 'July snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c08 IS 'August snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c09 IS 'September snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c10 IS 'October snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c11 IS 'November snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snw_pc_c12 IS 'December snow cover extent in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_cl_cmj IS 'Spatial majority of land cover class in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c01 IS 'Land Cover Extent class 1 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c02 IS 'Land Cover Extent class 2 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c03 IS 'Land Cover Extent class 3 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c04 IS 'Land Cover Extent class 4 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c05 IS 'Land Cover Extent class 5 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c06 IS 'Land Cover Extent class 6 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c07 IS 'Land Cover Extent class 7 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c08 IS 'Land Cover Extent class 8 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c09 IS 'Land Cover Extent class 9 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c10 IS 'Land Cover Extent class 10 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c11 IS 'Land Cover Extent class 11 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c12 IS 'Land Cover Extent class 12 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c13 IS 'Land Cover Extent class 13 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c14 IS 'Land Cover Extent class 14 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c15 IS 'Land Cover Extent class 15 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c16 IS 'Land Cover Extent class 16 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c17 IS 'Land Cover Extent class 17 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c18 IS 'Land Cover Extent class 18 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c19 IS 'Land Cover Extent class 19 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c20 IS 'Land Cover Extent class 20 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c21 IS 'Land Cover Extent class 21 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_c22 IS 'Land Cover Extent class 22 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u01 IS 'Land Cover Extent class 1 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u02 IS 'Land Cover Extent class 2 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u03 IS 'Land Cover Extent class 3 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u04 IS 'Land Cover Extent class 4 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u05 IS 'Land Cover Extent class 5 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u06 IS 'Land Cover Extent class 6 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u07 IS 'Land Cover Extent class 7 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u08 IS 'Land Cover Extent class 8 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u09 IS 'Land Cover Extent class 9 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u10 IS 'Land Cover Extent class 10 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u11 IS 'Land Cover Extent class 11 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u12 IS 'Land Cover Extent class 12 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u13 IS 'Land Cover Extent class 13 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u14 IS 'Land Cover Extent class 14 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u15 IS 'Land Cover Extent class 15 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u16 IS 'Land Cover Extent class 16 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u17 IS 'Land Cover Extent class 17 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u18 IS 'Land Cover Extent class 18 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u19 IS 'Land Cover Extent class 19 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u20 IS 'Land Cover Extent class 20 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u21 IS 'Land Cover Extent class 21 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.glc_pc_u22 IS 'Land Cover Extent class 22 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_cl_cmj IS 'Spatial majority of potential natural vegetation classes in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c01 IS 'Potential natural vegetation extent class 1 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c02 IS 'Potential natural vegetation extent class 2 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c03 IS 'Potential natural vegetation extent class 3 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c04 IS 'Potential natural vegetation extent class 4 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c05 IS 'Potential natural vegetation extent class 5 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c06 IS 'Potential natural vegetation extent class 6 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c07 IS 'Potential natural vegetation extent class 7 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c08 IS 'Potential natural vegetation extent class 8 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c09 IS 'Potential natural vegetation extent class 9 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c10 IS 'Potential natural vegetation extent class 10 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c11 IS 'Potential natural vegetation extent class 11 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c12 IS 'Potential natural vegetation extent class 12 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c13 IS 'Potential natural vegetation extent class 13 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c14 IS 'Potential natural vegetation extent class 14 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_c15 IS 'Potential natural vegetation extent class 15 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u01 IS 'Potential natural vegetation extent class 1 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u02 IS 'Potential natural vegetation extent class 2 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u03 IS 'Potential natural vegetation extent class 3 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u04 IS 'Potential natural vegetation extent class 4 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u05 IS 'Potential natural vegetation extent class 5 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u06 IS 'Potential natural vegetation extent class 6 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u07 IS 'Potential natural vegetation extent class 7 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u08 IS 'Potential natural vegetation extent class 8 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u09 IS 'Potential natural vegetation extent class 9 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u10 IS 'Potential natural vegetation extent class 10 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u11 IS 'Potential natural vegetation extent class 11 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u12 IS 'Potential natural vegetation extent class 12 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u13 IS 'Potential natural vegetation extent class 13 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u14 IS 'Potential natural vegetation extent class 14 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pnv_pc_u15 IS 'Potential natural vegetation extent class 15 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.wet_cl_cmj IS 'Spatial majority wetland class in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_cg1 IS 'Wetland extent class group 1 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_ug1 IS 'Wetland extent class group 1 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_cg2 IS 'Wetland extent class group 2 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_ug2 IS 'Wetland extent class group 2 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_c01 IS 'Wetland extent class 1 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_c02 IS 'Wetland extent class 2 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_c03 IS 'Wetland extent class 3 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_c04 IS 'Wetland extent class 4 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_c05 IS 'Wetland extent class 5 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_c06 IS 'Wetland extent class 6 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_c07 IS 'Wetland extent class 7 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_c08 IS 'Wetland extent class 8 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_c09 IS 'Wetland extent class 9 in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_u01 IS 'Wetland extent class 1 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_u02 IS 'Wetland extent class 2 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_u03 IS 'Wetland extent class 3 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_u04 IS 'Wetland extent class 4 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_u05 IS 'Wetland extent class 5 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_u06 IS 'Wetland extent class 6 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_u07 IS 'Wetland extent class 7 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_u08 IS 'Wetland extent class 8 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.wet_pc_u09 IS 'Wetland extent class 9 in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.for_pc_cse IS 'Spatial extent (%) of forest cover in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.for_pc_use IS 'Spatial extent (%) of forest cover in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.crp_pc_cse IS 'Spatial extent (%) of cropland in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.crp_pc_use IS 'Spatial extent (%) of cropland in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pst_pc_cse IS 'Spatial extent (%) of pasture in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pst_pc_use IS 'Spatial extent (%) of pasture in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.ire_pc_cse IS 'Spatial extent (%) of irrigated area in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.ire_pc_use IS 'Spatial extent (%) of irrigated area in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.gla_pc_cse IS 'Spatial extent (%) of glacier in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.gla_pc_use IS 'Spatial extent (%) of glacier in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.prm_pc_cse IS 'Spatial extent (%) of permafrost in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.prm_pc_use IS 'Spatial extent (%) of permafrost in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pac_pc_cse IS 'Spatial extent (%) of protected area in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pac_pc_use IS 'Spatial extent (%) of protected area in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.tbi_cl_cmj IS 'Spatial majority of terrestrial biomes in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.tec_cl_cmj IS 'Spatial majority of terrestrial ecoregions in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.fmh_cl_cmj IS 'Spatial majority of freshwater major habitat types in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.fec_cl_cmj IS 'Spatial majority of freshwater ecoregions in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cly_pc_cav IS 'Average clay fraction in soil in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.cly_pc_uav IS 'Average clay fraction in soil in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.slt_pc_cav IS 'Average silt fraction in soil in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.slt_pc_uav IS 'Average silt fraction in soil in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.snd_pc_cav IS 'Average sand fraction in soil in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.snd_pc_uav IS 'Average sand fraction in soil in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.soc_th_cav IS 'Average organic carbon content in soil in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.soc_th_uav IS 'Average organic carbon content fraction in soil in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_cyr IS 'Annual average soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_uyr IS 'Annual average soil water content in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c01 IS 'January soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c02 IS 'February soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c03 IS 'March soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c04 IS 'April soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c05 IS 'May soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c06 IS 'June soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c07 IS 'July soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c08 IS 'August soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c09 IS 'September soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c10 IS 'October soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c11 IS 'November soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.swc_pc_c12 IS 'December soil water content in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.lit_cl_cmj IS 'Spatial majority of lithological classes in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.kar_pc_cse IS 'Spatial extent (%) of Karst area in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.kar_pc_use IS 'Spatial extent (%) of Karst area in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.ero_kh_cav IS 'Average soil erosion in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.ero_kh_uav IS 'Average soil erosion in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.pop_ct_csu IS 'Population count in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.pop_ct_usu IS 'Population count in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.ppd_pk_cav IS 'Average population density in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.ppd_pk_uav IS 'Average population density in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.urb_pc_cse IS 'Spatial extent (%) of urban area in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.urb_pc_use IS 'Spatial extent (%) of urban area in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.nli_ix_cav IS 'Average nighttime lights in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.nli_ix_uav IS 'Average nighttime lights in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.rdd_mk_cav IS 'Average road density in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.rdd_mk_uav IS 'Average road density in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.hft_ix_c93 IS 'Human foorprint in reach catchment in 1993';
COMMENT ON COLUMN hydroa.riversegments.hft_ix_u93 IS 'Human footprint in total watershed upstream in 1993';
COMMENT ON COLUMN hydroa.riversegments.hft_ix_c09 IS 'Human foorprint in reach catchment in 2009';
COMMENT ON COLUMN hydroa.riversegments.hft_ix_u09 IS 'Human footprint in total watershed upstream in 2009';
COMMENT ON COLUMN hydroa.riversegments.gad_id_cmj IS 'Spatial majority of global administrative area in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.gdp_ud_cav IS 'Average gross domestic product in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.gdp_ud_csu IS 'Sum of gross domestic product in reach catchment';
COMMENT ON COLUMN hydroa.riversegments.gdp_ud_usu IS 'Sum of gross domestic product in total watershed upstream';
COMMENT ON COLUMN hydroa.riversegments.hdi_ix_cav IS 'Average human development index in reach catchment';
--COMMENT ON COLUMN hydroa.riversegments."source" IS '';
--COMMENT ON COLUMN hydroa.riversegments.ufid IS '';
...
--COMMENT ON COLUMN hydroa.catchments."source" IS '';
--COMMENT ON COLUMN hydroa.catchments.ufid IS '';
