...
Some development have been done with the [EU-hydro](https://github.com/DIASPARAproject/WP3_habitat/blob/main/R/habitatdb_eu_hydro.qmd), they relied however on a lot of fixes made by Andrew French 
which unfortunately couldn't be integrated at the time of finishing this report.
:::

::: {.callout-warning appearance="simple"}
The Hydrosheds here is just used as dictionary providing consistent names about
europe, it doesn't mean that other GIS will no be used by the different working groups, 
