...
format: 
  pdf:
    ...
    include-in-header:  
      - text: |
            \usepackage{tikz}
    include-before-body: habitatdbpdf_header.tex
    toc: true
    toc-depth: 3
    toc-title: Contents
...
[habitat database](https://diaspara.bordeaux-aquitaine.inrae.fr/deliverables/wp3/p8hab/rep5.html)
...
con_diaspara_loc <- dbConnect(Postgres(), 
...
data_description <- dbGetQuery(con_diaspara_loc, 
...
![The nested structure layed out in table tr_area_area, dotted box indicate that the level is optional. This table represents the structure for refbast.](images/fig-area_hierarchy_bast.png){#fig-area_hierarchy_bast}
...
**Code to create the 300, Gulf of Bothnia subdivision grouping level**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the Global Stock level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the Marine Stock level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the Marine Assessment unit level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the Marine Regional level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the ICES Divison level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the ICES Subdivision level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the Inland Stock level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the Inland Assessment unit level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the River level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the River section level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the Complex level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create an are_code for Lagoons without a name**
```{sql}
#| eval: FALSE
#| echo: TRUE
...
**Code to create the Lagoons level for WGEEL**
```{sql}
#| eval: FALSE
#| echo: TRUE
